...
fun MainSettingsScreen(
    ...
    onClickWordsDestroyed: () -> Unit, // AutoWrong stats
    onClickBack: () -> Unit,
) {
    SearchSettingsScreen(
        ...
        Scaffold(contentWindowInsets = WindowInsets.safeDrawing.only(WindowInsetsSides.Bottom)) { innerPadding ->
            Column(
                ...
                // AutoWrong: "Words Destroyed" stats entry at the top
                Preference(
                    name = "💀 Words Destroyed",
                    description = "How much damage has AutoWrong done?",
                    onClick = onClickWordsDestroyed,
