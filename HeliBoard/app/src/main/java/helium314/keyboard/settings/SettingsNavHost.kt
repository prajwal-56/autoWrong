...
// AutoWrong: stats screen
import helium314.keyboard.settings.screens.AutoWrongStatsScreen
    ...
    NavHost(
        ...
        composable(SettingsDestination.Settings) {
            MainSettingsScreen(
                ...
                onClickWordsDestroyed = { navController.navigate(SettingsDestination.WordsDestroyed) }, // AutoWrong
                onClickBack = ::goBack,
            )
        }
        ...
        // AutoWrong: stats screen route
        composable(SettingsDestination.WordsDestroyed) {
            AutoWrongStatsScreen(onClickBack = ::goBack)
        }
    }
...
object SettingsDestination {
    ...
    // AutoWrong: stats destination
    const val WordsDestroyed = "words_destroyed"
